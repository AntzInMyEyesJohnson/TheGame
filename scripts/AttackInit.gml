...
ani_atkcombo = SetAttackAnimation(ani_atkwindow_alarm);//must be before setting ani_atkwindow_alarm
ani_atkwindow_alarm = room_speed;//really means that for 1 second after attack you can continue combo
