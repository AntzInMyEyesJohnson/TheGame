Information about object: obj_comsoldier
Sprite: spr_axman_idle
Solid: false
Visible: true
Depth: 
0
...
ani_alarm = -1;
ani_length = 0;
ani_idle = spr_axman_idle;
ani_move = spr_axman_move;
ani_charge = spr_axman_charge;
ani_attack = spr_axman_attack;
ani_hit = spr_axman_hit;
//ani_dodge = spr_axman_dodge;
ani_parry = spr_axman_parry;
ani_retreat = spr_axman_retreat;
//ani_teleport = spr_axman_teleport;
ani_vulnerable = spr_axman_vulnerable;
ani_deathnormal = spr_axman_deathnormal;
ani_deathbyslash = spr_axman_deathbyslash;
ani_deathsplat = spr_axman_death_splat;
