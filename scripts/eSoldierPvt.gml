/*Information about object: obj_soldier_pvt
Sprite: spr_soldier_pvt_idle
Solid: false
Visible: true
Depth: 
0
...
ani_alarm = -1;
ani_length = 0;
ani_idle = spr_soldier_pvt_idle;
ani_move = spr_soldier_pvt_move;
ani_charge = spr_soldier_pvt_charge;
ani_attack = spr_soldier_pvt_attack;
ani_hit = spr_soldier_pvt_hit;
//ani_dodge = spr_soldier_pvt_dodge;
//ani_parry = spr_soldier_pvt_parry;
ani_retreat = spr_soldier_pvt_retreat;
//ani_teleport = spr_soldier_pvt_teleport;
ani_vulnerable = spr_soldier_pvt_vulnerable;
ani_deathnormal = spr_soldier_pvt_deathnormal;
ani_deathbyslash = spr_soldier_pvt_deathbyslash;
ani_deathsplat = spr_soldier_pvt_death_splat;
sound_eattack = //snd_ninja_shuriken1;
vuln_type = vSTUNNED;
my_click_count = 0;
my_attack_range = 160;
react_count = 0;
max_speed = 40/room_speed;
