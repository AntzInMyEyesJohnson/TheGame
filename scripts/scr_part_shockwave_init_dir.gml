///scr_part_shockwave_init_dir(direction);
//initialize our global shockwave particle
global.pt_shockwave = part_type_create();
var pt = global.pt_shockwave;

//shockwave particle settings
