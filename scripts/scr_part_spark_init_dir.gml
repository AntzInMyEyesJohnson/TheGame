...
part_type_size(pt,.04,.1,-.002,0);
part_type_scale(pt,1,.45);
...
part_type_alpha2(st,1,.8);
part_type_speed(st,.5,2,0,0);
part_type_direction(pt,_dir-30,_dir+30,0,0);
